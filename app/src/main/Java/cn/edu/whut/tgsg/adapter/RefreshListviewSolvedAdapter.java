 ...
 */
public class RefreshListviewSolvedAdapter extends CommonAdapter<GjEntity> {
     ...
     * @param gjEntities
     */
    public RefreshListviewSolvedAdapter(Context context, List<GjEntity> gjEntities) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder = ViewHolder.get(mContext, convertView, parent,
                R.layout.item_expert_ckgj_solved, position);
