...
import cn.edu.whut.tgsg.adapter.RefreshListviewPendingAdapter;
 ...
 */
public class ExpertPendingFragment extends BaseFragment implements ReFreshListView.IReFreshListener{
    ...
    //适配器
    private RefreshListviewPendingAdapter mAdapter;


    @Override
    protected int getContentLayoutId() {
        return R.layout.tab_expert_ckgj_pending;
    }
...
//            mListView = (ReFreshListView) getActivity().findViewById(R.id.refresh_listview);
            mAdapter = new RefreshListviewPendingAdapter(getActivity(),mGjEntities);
    ...
    protected void initData() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            entity.setName("诺一牌洗洁精"+i);
            entity.setReleaseTime("2015-12-10");
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mListView = (ReFreshListView) getActivity().findViewById(R.id.refresh_listview_pending);
